...
{
    public class Teklif2Servisi : ITeklif2Servisi
    {
        ...
        private readonly IDepo<Teklif2> _teklifDepo;
        private readonly IWorkContext _workContext;
        private readonly IOlayYayınlayıcı _olayYayınlayıcı;
        private readonly IÖnbellekYönetici _önbellekYönetici;
        public Teklif2Servisi(IDepo<Teklif2> teklifDepo,
        ...
        public void TeklifEkle(Teklif2 teklif)
        {
            if (teklif == null)
        ...
        public void TeklifGüncelle(Teklif2 teklif)
        {
            if (teklif == null)
                throw new ArgumentNullException("teklif");
        ...
        public void TeklifSil(Teklif2 teklif)
        {
            if (teklif == null)
                throw new ArgumentNullException("teklif");
        ...
        public IList<Teklif2> TümTeklifAl( bool AclYoksay = false, bool gizliOlanlarıGöster = false)
        {
        ...
        public ISayfalıListe<Teklif2> TeklifAra(DateTime? tarihinden = null,
            ...
            int sayfaIndeksi = 0, int sayfaBüyüklüğü = int.MaxValue)
        {
            ...
            var teklifler = new SayfalıListe<Teklif2>(sorgu, sayfaIndeksi, sayfaBüyüklüğü);
            return teklifler;
        }
    }
}
