...
{
    public class BagliTeklifOgesi2Servisi : IBagliTeklifOgesi2Servisi
    {
        ...
        private readonly IDepo<BagliTeklifOgesi2> _bagliTeklifOgesiDepo;
        private readonly ITeklifServisi _teklifServisi;
        private readonly IDepo<Teklif> _teklifDepo;
        public BagliTeklifOgesi2Servisi(
            IDepo<BagliTeklifOgesi2> bagliTeklifOgesiDepo,
        ...
        public BagliTeklifOgesi2 BagliTeklifOgesi2AlId(int bagliTeklifOgesiId)
        {
        ...
        public void BagliTeklifOgesi2Ekle(BagliTeklifOgesi2 bagliTeklifOgesi)
        {
        ...
        public void BagliTeklifOgesi2Güncelle(BagliTeklifOgesi2 bagliTeklifOgesi)
        {
            if (bagliTeklifOgesi == null)
                throw new ArgumentNullException("bagliTeklifOgesi");
        ...
        public IList<BagliTeklifOgesi2> TümBagliTeklifOgesi2Al( bool AclYoksay = false, bool gizliOlanlarıGöster = false)
        {
        ...
        public IList<BagliTeklifOgesi2> BagliTeklifOgesi2AlTeklifId(int teklifId )
        {
            if (teklifId == 0)
                return null;
        ...
        public IList<BagliTeklifOgesi2> BagliTeklifOgesi2AlTeklifId(int teklifId, string durumu )
        {
            if (teklifId == 0)
                return null;
            if (durumu == "Hazırlık")
            ...
            if (durumu == "Konfirme")
            {
                BagliTeklifOgesi2AlTeklifId(teklifId);
            }
