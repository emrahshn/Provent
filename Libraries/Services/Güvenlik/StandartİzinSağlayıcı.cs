...
namespace Services.Güvenlik
{
    public partial class StandartİzinSağlayıcı : IİzinSağlayıcı
    {
        ...
        public static readonly İzinKaydı KongreYönet = new İzinKaydı { Adı = "Site. Kongre Yönet", SistemAdı = "KongreYönet", Kategori = "Site" };
        public static readonly İzinKaydı CrmYönet = new İzinKaydı { Adı = "Site. Crm Yönet", SistemAdı = "CrmYönet", Kategori = "Site" };
