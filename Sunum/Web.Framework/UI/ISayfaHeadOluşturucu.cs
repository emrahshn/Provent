...
namespace Web.Framework.UI
{
    public partial interface ISayfaHeadOluşturucu
    {
        ...
        void ScriptParçasıEkle(KaynakKonumu konum, string parça, bool pakettinDışında, bool isAync);
        void ScriptParçasıIlaveEt(KaynakKonumu konum, string parça, bool pakettinDışında, bool isAsync);
        string ScriptsOluştur(UrlHelper urlHelper, KaynakKonumu konum, bool? paketDosyaları = null);
        void CssParçasıEkle(KaynakKonumu konum, string parça, bool pakettinDışında = false);
        void CssParçasıIlaveEt(KaynakKonumu konum, string parça, bool pakettinDışında = false);
        string CssOluştur(UrlHelper urlHelper, KaynakKonumu konum, bool? paketDosyaları = null);
