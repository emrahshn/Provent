...
namespace Eklentiler.Widgets.NivoSlider
{
    public class NivoSliderPlugin : TemelEklenti, IWidgetEklenti
    {
        ...
        public void YapılandırmaRotasınıAl(out string actionName, out string controllerName, out RouteValueDictionary routeValues)
        {
            actionName = "Configure";
            controllerName = "WidgetsNivoSlider";
            routeValues = new RouteValueDictionary { { "Namespaces", "Eklentiler.Widgets.NivoSlider.Controllers" }, { "area", null } };
        }
        public void GörüntülemeRotasınıAl(string widgetZone, out string actionName, out string controllerName, out RouteValueDictionary routeValues)
        {
            actionName = "PublicInfo";
            controllerName = "WidgetsNivoSlider";
            routeValues = new RouteValueDictionary
            {
                {"Namespaces", "Eklentiler.Widgets.NivoSlider.Controllers"},
                {"area", null},
